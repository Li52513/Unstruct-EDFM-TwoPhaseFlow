...
int main()
{
    ...
    //给定参数：2D情况，给定基岩四个边界条件系数
    PressureBC::Registry pbc_pw;
    PressureBC::BoundaryCoefficient P_Left{ 1.0, 0.0,8e6 }; 
    PressureBC::BoundaryCoefficient P_Right{ 1.0, 0.0,7.5e6 };
    ...
    //    你也可以把 outPrefixP/outPrefixT 改成你的绝对路径，例如：
    //    "D:/Yongwei/.../Postprocess_Data/P_CO2/p" 与 "D:/.../Postprocess_Data/T_CO2/t"
    bool ok = runTransient_constProperties_singlePhase_CO2_T_H(
        mgr, reg, freg, ppm,
        TbcA, PbcA, g,
        nSteps, dt, sc,
        /*writeEveryP*/ 100, /*writeEveryT*/ 100,
