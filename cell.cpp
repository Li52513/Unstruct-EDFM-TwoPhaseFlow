...
Cell::Cell(int id, const std::vector<int>& nodeIDs)
	: id(id), nodeIDs(nodeIDs), volume(0.0), center(0.0, 0.0, 0.0), sourceTerm(0.0), faceDiscreCoef(0.0), pressure(6.621e6), pressureGradient(0.0, 0.0, 0.0), temperature(487.55), saturation_water(0.8), saturation_CO2(0.2), error(1e-6), SolidMaterialProps(), WaterMaterialProps(), CO2MaterialProps()  // 初始化物性参数
{
