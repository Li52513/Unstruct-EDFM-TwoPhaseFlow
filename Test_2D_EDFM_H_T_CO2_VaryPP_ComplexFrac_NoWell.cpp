...
constexpr const char* kPlanKey = "h_t_co2_varypp_complexfrac_nowell";
constexpr const char* kSmokeKey = "h_t_co2_varypp_complexfrac_nowell_smoke";
constexpr const char* kPrepareKey = "h_t_co2_varypp_complexfrac_nowell_prepare_reference";
constexpr const char* kValidateKey = "h_t_co2_varypp_complexfrac_nowell_validate_reference";
constexpr const char* kFullKey = "h_t_co2_varypp_complexfrac_nowell_full_comsol";
