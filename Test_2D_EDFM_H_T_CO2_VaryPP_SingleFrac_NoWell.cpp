...
constexpr const char* kPlanKey = "h_t_co2_varypp_singlefrac_nowell";
constexpr const char* kSmokeKey = "h_t_co2_varypp_singlefrac_nowell_smoke";
constexpr const char* kPrepareKey = "h_t_co2_varypp_singlefrac_nowell_prepare_reference";
constexpr const char* kValidateKey = "h_t_co2_varypp_singlefrac_nowell_validate_reference";
constexpr const char* kFullKey = "h_t_co2_varypp_singlefrac_nowell_full_comsol";
